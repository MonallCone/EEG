...
namespace EmotivUnityPlugin
{
    ...
    public class EmotivUnityItf
    {
        ...
        // متغیرهای جدید برای ذخیره حالات چهره
        public string curUAct = "neutral";   // تعجب یا اخم
        public double curUPow = 0;
        public string curLAct = "neutral";   // لبخند یا فشار دندان
        public double curLPow = 0;
        public string curEyeAct = "neutral"; // پلک زدن یا چشمک
        ...
        private void OnFacialExpReceived(object sender, FacEventArgs data)
        {
            ...
            // print out data to console
            UnityEngine.Debug.Log(dataText);
            this.curUAct = data.UAct;
            this.curUPow = data.UPow;
            this.curLAct = data.LAct;
            this.curLPow = data.LPow;
            this.curEyeAct = data.EyeAct;
        }
